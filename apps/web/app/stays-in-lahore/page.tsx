...
import { lahore } from "@/lib/content/cities/lahore";
import { pageMetadata } from "@/lib/seo/metadata";

/**
 * GW-002 (template) — `/stays-in-lahore`.
 *
 ...
 * and links in `lib/content/cities/lahore.ts`.
 */
export const metadata = pageMetadata(lahore.path, lahore.metaDescription);

export default function LahoreCityPage() {
  return <CityLandingPage city={lahore} />;
}
