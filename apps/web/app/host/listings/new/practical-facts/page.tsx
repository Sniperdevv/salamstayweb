...
import PracticalFactsStep from "./step";

/**
 * Step 5 of 9 — the route. The step itself is `./step.tsx`.
 *
...
export const metadata: Metadata = {
  title: { absolute: "Practical facts — list your place on SalamStay" },
};

export default function PracticalFactsRoute() {
  return <PracticalFactsStep />;
}
