...
import TitleDescriptionStep from "./step";

/**
 * Step 7 of 9 — the route. The step itself is `./step.tsx`.
 *
...
export const metadata: Metadata = {
  title: { absolute: "Title and description — list your place on SalamStay" },
};

export default function TitleDescriptionRoute() {
  return <TitleDescriptionStep />;
}
