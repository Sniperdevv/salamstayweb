...
> house rule at the weight of "no smoking", and **women-only stays** as a safety category.
>
...
**The registry is nine numbered slots. Eight are live. Slot 6 is RETIRED and must stay a slot.**
...
- A claim **not in this registry does not ship.** Adding, editing, or extending a claim requires **founder sign-off** first. **Retiring a claim requires the same founder sign-off** — slot 6 has it and no other slot does.
...
- **Claims 4 and 5 keep their wording and change their register.** *No-alcohol listings by default* is a **house rule** carrying exactly the weight of "no smoking" or "no parties" — never a moral position, never a virtue. *Women-only stays hosted by women* is a **safety category** — never a modesty one.
- **FORBIDDEN, always:**
